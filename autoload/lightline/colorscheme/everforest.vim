...
let s:tab_middle_fg = s:palette.red
...
let s:normal_middle_fg = s:palette.red
...
let s:visual_middle_fg = s:palette.red
...
let s:replace_middle_fg = s:palette.red
...
let s:command_middle_fg = s:palette.red
...
let s:terminal_middle_fg = s:palette.red
let s:terminal_middle_bg = s:palette.bg1

let s:inactive_l1_fg = s:palette.red
let s:inactive_l1_bg = s:palette.bg1
let s:inactive_l2_fg = s:palette.red
let s:inactive_l2_bg = s:palette.bg1
let s:inactive_r1_fg = s:palette.red
let s:inactive_r1_bg = s:palette.bg1
let s:inactive_r2_fg = s:palette.red
let s:inactive_r2_bg = s:palette.bg1
let s:inactive_middle_fg = s:palette.red
