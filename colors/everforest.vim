...
if s:configuration.enable_italic
  ...
  call everforest#highlight('Conditional', s:palette.pink, s:palette.none, 'italic')
  call everforest#highlight('Repeat', s:palette.red, s:palette.none, 'italic')
  call everforest#highlight('Keyword', s:palette.pink, s:palette.none, 'italic')
  ...
  call everforest#highlight('Conditional', s:palette.pink, s:palette.none)
  call everforest#highlight('Repeat', s:palette.red, s:palette.none)
  call everforest#highlight('Keyword', s:palette.pink, s:palette.none)
