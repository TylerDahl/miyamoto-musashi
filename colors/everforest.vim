...
if s:configuration.transparent_background == 2
  ...
  call everforest#highlight('StatusLineTermNC', s:palette.grey1, s:palette.red)
  call everforest#highlight('TabLine', s:palette.grey2, s:palette.red)
  call everforest#highlight('TabLineFill', s:palette.grey1, s:palette.red)
  call everforest#highlight('TabLineSel', s:palette.bg0, s:palette.red)
else
  call everforest#highlight('StatusLine', s:palette.grey1, s:palette.red)
  call everforest#highlight('StatusLineTerm', s:palette.grey1, s:palette.red)
  call everforest#highlight('StatusLineNC', s:palette.grey1, s:palette.red)
