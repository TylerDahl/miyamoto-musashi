...
if s:configuration.disable_italic_comment
  call everforest#highlight('Comment', s:palette.grey0, s:palette.none)		" comment
  ...
  call everforest#highlight('Comment', s:palette.grey0, s:palette.none, 'italic')	" comment
